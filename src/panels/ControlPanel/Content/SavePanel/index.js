        ...
        return (
            <div className={ [ this.props.className, style.container ].join(' ') }>
                ...
                <CollapsibleWidget open={false} subtitle='Remote' title='Screenshot'>
                    ...
                    <div className={ style.line }>
                        <i className={ this.state.screenMessage === 'success'
